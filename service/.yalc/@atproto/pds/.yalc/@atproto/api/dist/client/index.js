...
exports.ComAtprotoServerCreateSIWELogin = __importStar(require("./types/com/atproto/server/createSIWELogin.js"));
exports.ComAtprotoServerCreateSIWERegistration = __importStar(require("./types/com/atproto/server/createSIWERegistration.js"));
...
class ComAtprotoServerNS {
    ...
    createSIWELogin(data, opts) {
        return this._client.call('com.atproto.server.createSIWELogin', opts?.qp, data, opts);
    }
    createSIWERegistration(data, opts) {
        return this._client.call('com.atproto.server.createSIWERegistration', opts?.qp, data, opts);
    }
