...
exports.schemaDict = {
                ...
                input: {
                    ...
                    schema: {
                        ...
                        properties: {
                            ...
                            ethAddress: {
                                type: 'string',
                                description: 'Initial ethereum address to be associated with the account, used to log in with signature',
                            },
                            siweSignature: {
                                type: 'string',
                                description: 'Signature to verify if user is owner of ethAddress',
                            },
                            recoveryKey: {
                                type: 'string',
    ...
    ComAtprotoServerCreateSIWERegistration: {
        ...
        defs: {
            main: {
                type: 'procedure',
                description: 'Creates a SIWE (Sign-In with Ethereum) message for registration.',
                input: {
                    encoding: 'application/json',
                    schema: {
                        type: 'object',
...
exports.ids = {
    ...
    ComAtprotoServerCreateSIWERegistration: 'com.atproto.server.createSIWERegistration',
