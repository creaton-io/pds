...
export declare class AccountManager {
    ...
    createAccount({ did, handle, email, ethAddress, siweSignature, password, repoCid, repoRev, inviteCode, deactivated, refreshJwt, }: {
        did: string;
        handle: string;
        email?: string;
        ethAddress?: string;
    ...
    siweLogin(did: string): Promise<string>;
    siweRegistration(ethAddress: string): Promise<string>;
    login({ identifier, siweSignature, password, }: {
        identifier: string;
    ...
    verifySIWELogin(did: string, siweSignature: Hex): Promise<boolean>;
    verifySIWERegistration(ethAddress: string, siweSignature: Hex): Promise<boolean>;
