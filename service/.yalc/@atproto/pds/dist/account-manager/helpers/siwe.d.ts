...
export declare const verifySIWELogin: (db: AccountDb, did: string, siweSignature: Hex) => Promise<boolean>;
export declare const verifySIWERegistration: (db: AccountDb, ethAddress: string, siweSignature: Hex) => Promise<boolean>;
export declare const siweLogin: (db: AccountDb, did: string) => Promise<string>;
export declare const siweRegistration: (db: AccountDb, ethAddress: string) => Promise<string>;
